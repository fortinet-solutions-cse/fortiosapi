...
--ram 1024 --disk path=fortios.qcow2,bus=virtio --disk path=/var/lib/libvirt/images/fostest.qcow2,size=10,bus=virtio \
--vcpus=1 --os-type=linux --cpu=host --import --noautoconsole --keymap=en-us \
--network=default,model=virtio,mac=40:40:40:01:02:03 --network bridge=docker0,model=virtio
